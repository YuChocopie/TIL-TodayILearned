MainActivity
~~~
package com.mashup.kim_yujeong.test
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //선그래프
        val dayTimeTemperture = intArrayOf(15, 3, 7, 8, -4, 1, 3, 6)
        ...
        val weekGraphView = findViewById(R.id.GraphViewWeek) as? GraphViewWeek
        val dayGraphView = findViewById(R.id.GraphViewTime) as? GraphViewDay
...
<android.support.constraint.ConstraintLayout
    ...
    <com.mashup.kim_yujeong.test.GraphViewDay
    ...
    <com.mashup.kim_yujeong.test.GraphViewWeek
